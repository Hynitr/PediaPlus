    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="row mb-3 align-items-stretch">
                ...
                <?php
$sql = "SELECT * FROM pq WHERE `title` LIKE '%$txt%' OR `code` LIKE '%$txt%' OR `inst` LIKE '%$inst%' OR `dept` LIKE '%$dept%' OR `level` LIKE '%$level%' OR `fcg` LIKE '%$fcg%' AND `approve` = 'Yes'";
$rsl = query($sql);
        ...
        <div class="col-md-3 ml-auto">
            ...
            <div class="mb-5">
                ...
                <ul class="list-unstyled post-lists">
                    <?php 
$sql = "SELECT * FROM pdf WHERE `title` LIKE '%$txt%' OR `code` = '%$txt%' OR `inst` LIKE '%$inst%' OR `dept` LIKE '%$dept%' OR `level` LIKE '%$level%' OR `fcg` LIKE '%$fcg%' AND `approve` = 'Yes' ORDER BY RAND() LIMIT 5";
$rsl = query($sql);
