    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="row mb-3 align-items-stretch">
                ...
                <?php
$sql = "SELECT * FROM pq WHERE `title` LIKE '%$txt%' OR `code` LIKE '%$txt%' AND `inst` LIKE '%$inst%' AND `dept` LIKE '%$dept%' AND `level` LIKE '%$level%' AND `fcg` LIKE '%$fcg%' AND `approve` = 'Yes'";
$rsl = query($sql);
...
?>
        ...
        <div class="col-md-3 ml-auto">
            ...
            <div class="mb-5">
                <h3 class="h5 text-black mb-3">Related PDF(s)</h3>
                <ul class="list-unstyled post-lists">
                    <?php 
$sql = "SELECT * FROM pdf WHERE `title` LIKE '%$txt%' OR `code` = '%$txt%' AND `inst` LIKE '%$inst%' AND `dept` LIKE '%$dept%' AND `level` LIKE '%$level%' AND `fcg` LIKE '%$fcg%' AND `approve` = 'Yes' ORDER BY RAND() LIMIT 5";
$rsl = query($sql);
...
?>
            ...
            <div class="mb-5">
                ...
                <ul class="list-unstyled post-lists">
                    <?php 
     $sql = "SELECT * FROM tutor WHERE `title` LIKE '%$txt%' AND `inst` LIKE '%$inst%' AND `dept` LIKE '%$dept%' AND `level` LIKE '%$level%' AND `fcg` LIKE '%$fcg%' AND `approve` = 'Yes' ORDER BY RAND() LIMIT 5";
     $rsl = query($sql);
